def main():
    ...
    classifier.add(Convolution2D(32, (3, 3), activation='relu', kernel_regularizer=regularizers.l2(0.01), input_shape=(64, 64, 3)))
    
    #step 2 - Pooling
    classifier.add(MaxPooling2D(pool_size =(2,2)))
    
    # Adding second convolution layer
    classifier.add(Convolution2D(64, (3, 3), activation='relu', kernel_regularizer=regularizers.l2(0.01)))
    classifier.add(MaxPooling2D(pool_size =(2,2)))
    
    #Adding 3rd Concolution Layer
    classifier.add(64, (3, 3), activation='relu', kernel_regularizer=regularizers.l2(0.01))
    classifier.add(MaxPooling2D(pool_size =(2,2)))
    
    #Adding 4rd Concolution Layer
    classifier.add(128, (3, 3), activation='relu', kernel_regularizer=regularizers.l2(0.01))
    classifier.add(MaxPooling2D(pool_size =(2,2)))
    ...
    classifier.add(Dense(128, activation='relu' , kernel_regularizer=regularizers.l2(0.01)))
    ...
    #Saving the model
    #import h5py
    classifier.save(basepath + '/New_model.h5')
